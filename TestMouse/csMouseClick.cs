...
namespace AutoMouse
{
    class csMouseClick
    {
        ...
        internal static void LeftClick(int delay)
        {
        ...
        internal static void RightClick(int delay)
        {
            csMouseClick.mouse_event(csMouseClick.MOUSEEVENTF_MOVE, 1, 1, 0, 0);
            Thread.Sleep(delay);
            csMouseClick.mouse_event(csMouseClick.MOUSEEVENTF_RIGHTDOWN, 0, 0, 0, 0);
            Thread.Sleep(delay);
            csMouseClick.mouse_event(csMouseClick.MOUSEEVENTF_RIGHTUP, 0, 0, 0, 0);
        }
    }
}
